namespace TexasHoldem.Tests.GameSimulations
{
    ...
    using TexasHoldem.Tests.GameSimulations.ForcedBetSimulators;
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            SimulateGames(new ForcedBetVsSmartPlayerSimulator());
            SimulateGames(new ForcedBetVsDummyPlayerSimulator());
            SimulateGames(new ForcedBetVsAlwaysCallPlayerSimulator());
        }
